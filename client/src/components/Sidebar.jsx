  ...
  return (
    <div
      className={` text-gray-600 h-screen ${
        isCollapsed ? "w-16 bg-white" : "w-52 bg-secondary"
      } transition-all`}
    >
      ...
      {!isCollapsed && (
        <div className="p-4 text-md font-semibold gap-5 flex flex-col">
          <Link to={`/${id}/task`} className="flex gap-2 items-center ">
            <MdOutlineCheckBox /> Tasks
          </Link>
          <Link to={`/${id}/team`} className="flex gap-2 items-center ">
            {" "}
            <FaRegUser />
            Team
          </Link>
          <Link to={`/${id}/update`} className="flex gap-2 items-center ">
            <MdUpdate /> Updates
          </Link>
          <Link to={`/${id}/analysis`} className="flex gap-2 items-center ">
            <MdBarChart /> Analysis
          </Link>
          <Link to={`/${id}/chat`} className="flex gap-2 items-center ">
            <MdChatBubbleOutline /> Chats
          </Link>
          <Link to={`/${id}/report`} className="flex gap-2 items-center ">
            <TbReport />
            Reports
          </Link>
        </div>
